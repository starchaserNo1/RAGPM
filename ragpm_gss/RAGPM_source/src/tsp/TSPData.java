...
public class TSPData
{
    ...
    static
    {
        ...
        int[][] cityPosition=
                {
                    {0,0},{12,32},{5,25},{8,45},{33,17}, {25,7},{15,15},{15,25},{25,15},{41,12}
                };   //10个城市（最优解:147）

        int[][] cityPosition_2=
                {
                    {60,200},{180,200},{80,180},{140,180}, {20,160},{100,160},{200,160},{140,140}, {40,120},{100,120},
                    {180,100},{60,80}, {120,80},{180,60},{20,40},{100,40}, {200,40},{20,20},{60,20},{160,20}
                };//20个城市（最优解:870）

        int[][] cityPosition_3=
                {
                    {1304, 2312},{3639, 1315}, {4177, 2244},{3712, 1399}, {3488, 1535},{3326, 1556}, {3238, 1229},{4196, 1004}, {4312, 790},{4386, 570},
        ...
        //路径集合
        CITY_NUM=cityPosition.length;         // 上面三组用例都可以用，用的时候将数组名称改为 cityPosition 即可
